...
export default function App({ Component, pageProps, router }: AppProps) {
  ...
  return (
    <>
      <NextSeo
        title="JOAN ROTBARD"
        description="Hey, my name is JOAN ROTBARD. I am a Fullstack Software Engineer from Argentina, I’m passionate about creating beautiful, intuitive and responsive websites."
        openGraph={{
          title: "JOAN ROTBARD",
          description:
            "Hey, my name is JOAN ROTBARD. I am a Fullstack Software Engineer from Argentina, I’m passionate about creating beautiful, intuitive and responsive websites.",
          siteName: "JOAN ROTBARD | Fullstack Software Engineer",
        }}
        twitter={{
          handle: "@ln_dev7",
          site: "@ln_dev7",
